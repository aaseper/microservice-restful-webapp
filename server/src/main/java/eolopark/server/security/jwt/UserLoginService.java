...
public class UserLoginService {
    ...
    /* Constructor */
    UserLoginService (AuthenticationManager authenticationManager, UserDetailsService userDetailsService,
                      JwtTokenProvider jwtTokenProvider, JwtCookieManager cookieUtil) {
    ...
    public ResponseEntity<AuthResponse> login (LoginRequest loginRequest, String encryptedAccessToken,
        ...
        loginRequest = new LoginRequest(loginRequest.getUsername(), loginRequest.getPassword());
        ...
        AuthResponse loginResponse = new AuthResponse(AuthResponse.Status.SUCCESS, "Auth successful. Tokens are " +
                "created in cookie.");
    ...
    public ResponseEntity<AuthResponse> refresh (String encryptedRefreshToken) {
        ...
        if (!refreshTokenValid) {
            AuthResponse loginResponse = new AuthResponse(AuthResponse.Status.FAILURE, "Invalid refresh token !");
